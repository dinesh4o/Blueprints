...
import { Sparkles, LogIn, Eye, EyeOff, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-6 relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        >
          <div className="p-2 bg-primary/20 rounded-full"><LogIn className="text-primary w-5 h-5" /></div>
          <span className="font-semibold text-sm text-foreground">Secure Login</span>
        </motion.div>

        <motion.div
          animate={{ y: [0, 25, 0], rotate: [0, -3, 3, 0] }}
          transition={{ duration: 7, repeat: Infinity, ease: 'easeInOut', delay: 1 }}
          className={`absolute top-[18%] right-[10%] p-4 rounded-2xl flex items-center gap-3 ${glassStyle}`}
        >
        ...
        >
          <div className="p-2 bg-primary/20 rounded-full"><ShieldCheck className="text-primary w-5 h-5" /></div>
          <span className="font-semibold text-sm text-foreground">OAuth 2.0</span>
        </motion.div>

        <motion.div
          animate={{ y: [0, -15, 0], x: [0, 10, 0] }}
          transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut', delay: 2 }}
          className={`absolute bottom-[22%] left-[12%] p-4 rounded-2xl flex items-center gap-3 ${glassStyle}`}
        >
          <div className="p-2 bg-primary/20 rounded-full"><GoogleIcon /></div>
          <span className="font-semibold text-sm text-foreground">Google Sign-in</span>
        </motion.div>
      </div>
