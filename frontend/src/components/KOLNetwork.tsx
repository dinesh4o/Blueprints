...
export default function KOLNetwork({ literatureData }: KOLNetworkProps) {
  ...
  if (!literatureData || literatureData.length === 0) {
    return <div className="flex items-center justify-center h-[400px] text-muted-foreground">No collaboration network found. Try a compound with more clinical literature.</div>;
  }
