...
export default function LandingPage() {
  ...
  return (
    <main className="bg-[#f8fafc] dark:bg-[#000000] min-h-screen">
      <div ref={containerRef} className="relative h-[250vh] overflow-clip font-sans selection:bg-zinc-800">
        ...
        <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="absolute top-[40%] md:top-[50%] flex justify-center z-10 w-full pointer-events-none px-4 md:px-8">
      ...
      <section className="relative py-24 px-6 md:px-12 bg-white dark:bg-[#09090b] border-t border-zinc-200 dark:border-zinc-800/50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-semibold text-zinc-900 dark:text-white mb-16 text-center tracking-tight">How It Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-10 rounded-[2rem] bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-100 dark:border-zinc-800">
              <div className="w-14 h-14 rounded-full bg-blue-100 dark:bg-zinc-800 flex items-center justify-center mb-8 text-blue-600 dark:text-zinc-300 font-bold text-xl shadow-inner">1</div>
              <h3 className="text-2xl font-medium text-zinc-900 dark:text-white mb-4">Ingest & Parse</h3>
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed font-light">Connect diverse clinical data sources, literature, and internal registries into a unified knowledge graph.</p>
            </div>
            <div className="p-10 rounded-[2rem] bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-100 dark:border-zinc-800">
              <div className="w-14 h-14 rounded-full bg-blue-100 dark:bg-zinc-800 flex items-center justify-center mb-8 text-blue-600 dark:text-zinc-300 font-bold text-xl shadow-inner">2</div>
              <h3 className="text-2xl font-medium text-zinc-900 dark:text-white mb-4">AI Agents</h3>
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed font-light">Our specialized AI agents collaborate to extract entities, verify claims, and build comprehensive structures.</p>
            </div>
            <div className="p-10 rounded-[2rem] bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-100 dark:border-zinc-800">
              <div className="w-14 h-14 rounded-full bg-blue-100 dark:bg-zinc-800 flex items-center justify-center mb-8 text-blue-600 dark:text-zinc-300 font-bold text-xl shadow-inner">3</div>
              <h3 className="text-2xl font-medium text-zinc-900 dark:text-white mb-4">Action Insights</h3>
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed font-light">Generate submission-ready regulatory reports and viability scores updated dynamically as new data arrives.</p>
            </div>
          </div>
        </div>
      </section>

      <footer className="py-12 border-t border-zinc-200 dark:border-zinc-900 bg-[#f8fafc] dark:bg-[#000000] text-center">
        <p className="text-zinc-500 dark:text-zinc-600 text-sm tracking-wide">© 2026 Autonomous Research. All rights reserved.</p>
      </footer>
    </main>
  );
}
